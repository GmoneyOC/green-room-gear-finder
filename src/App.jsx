...
index b767bc5e74049481ec8e1a7142029cba3994de72..a2a85ff9e453ac3f012fb236f9b06c7125bcc009 100644
--- a/src/App.jsx
+++ b/src/App.jsx
@@ -1,218 +1,366 @@
...
+                  <strong>Size guidance:</strong> {sizeRecommendation} (based on your height and weight)
+                </div>
+              )}
+            </div>
+          )}
...
+                      {product.matches.length > 0 && (
+                        <p className="text-xs text-blue-50 mb-3">Matched on: {product.matches.join(', ')}</p>
+                      )}
